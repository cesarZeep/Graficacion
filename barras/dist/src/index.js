...
function setupSliders() {
    ...
    sliders.forEach(slider => {
        ...
        slider.addEventListener('input', (e) => {
            ...
            miCanvas === null || miCanvas === void 0 ? void 0 : miCanvas.updateBar(barIndex, percentage);
        });
    });
}
/**
...
function updateSliderLabel(slider, value) {
    var _a, _b;
    const label = (_a = slider.closest('.control-group')) === null || _a === void 0 ? void 0 : _a.querySelector('label');
    if (label) {
        const labelText = ((_b = label.textContent) === null || _b === void 0 ? void 0 : _b.split('(')[0]) || '';
...
function setupColorPickers() {
    ...
    colorOptions.forEach(option => {
        ...
        option.addEventListener('click', (e) => {
            ...
            const slider = document.querySelector(`.slider[data-bar="${barIndex}"]`);
            const currentValue = parseInt(slider.value);
            // Actualizar solo el color manteniendo el porcentaje
            miCanvas === null || miCanvas === void 0 ? void 0 : miCanvas.updateBar(barIndex, currentValue, color);
            // Actualizar interfaz
 ...
 */
function updateActiveColor(barIndex, selectedOption) {
...
function setupButtons() {
    ...
    if (toggle3dBtn) {
        toggle3dBtn.addEventListener('click', () => {
            miCanvas === null || miCanvas === void 0 ? void 0 : miCanvas.toggle3DEffect();
